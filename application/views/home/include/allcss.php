...
<link rel="stylesheet" href="<?php echo base_url('assets/');?>css/woocommerce/woocommerce-layout.css" type="text/css" media="all" />
<link rel="stylesheet" href="<?php echo base_url('assets/');?>css/woocommerce/woocommerce-smallscreen.css" type="text/css" media="only screen and (max-width: 768px)" />
<link rel="stylesheet" href="<?php echo base_url('assets/');?>css/woocommerce/woocommerce.css" type="text/css" media="all" />

<link rel="stylesheet" href="<?php echo base_url('assets/');?>css/style.css" type="text/css" media="all" />
<link rel="stylesheet" href="<?php echo base_url('assets/');?>css/shortcodes.css" type="text/css" media="all" />
<link rel="stylesheet" href="<?php echo base_url('assets/');?>css/core.animation.css" type="text/css" media="all" />
<link rel="stylesheet" href="<?php echo base_url('assets/');?>css/tribe-style.css" type="text/css" media="all" />
<link rel="stylesheet" href="<?php echo base_url('assets/');?>css/skins/skin.css" type="text/css" media="all" />
...
<link rel="stylesheet" href="<?php echo base_url('assets/');?>css/skins/skin-responsive.css" type="text/css" media="all" />
<link rel="stylesheet" href="<?php echo base_url('assets/');?>css/slider-style.css" type="text/css" media="all" />
<link rel="stylesheet" href="<?php echo base_url('assets/');?>css/custom-style.css" type="text/css" media="all" />
