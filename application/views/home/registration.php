                    ...
                    <div class="content">
                        <article class="post_item post_item_single page">
                            <section class="post_content">
								<div class="woocommerce" style="margin:15px">
										...
										<div class="col-1">
                                          ...
                                          <!--  <div class="col-2">
                                            <form name="checkout" method="post" class="checkout woocommerce-checkout" action="#" enctype="multipart/form-data">
												<div class="woocommerce-billing-fields">
													<h3>Login</h3>
													<p class="form-row form-row-wide" id="billing_first_name_field">
														<label for="billing_first_name" class=""> User Name<abbr class="required" title="required">*</abbr></label>
														<input type="text" class="input-text" name="billing_first_name" id="billing_first_name" placeholder="" value="">
													</p>
													<p class="form-row form-row-wide" id="billing_last_name_field">
