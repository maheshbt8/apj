<header class="top_panel_wrap bg_tint_dark">
                ...
                <div class="menu_user_wrap">
                    <div class="content_wrap clearfix">
                        <div class="menu_user_area menu_user_right menu_user_nav_area">
                            <ul id="menu_user" class="menu_user_nav inited sf-js-enabled sf-arrows" style="touch-action: pan-y;">
                                <li class="menu_user_bookmarks">
                                    <a href="#" class="bookmarks_show icon-star-1 sf-with-ul" title="Show bookmarks"></a>
                                    <ul class="bookmarks_list animated fast fadeOutDown" style="display: none;">
                                ...
                                <li class="menu_user_controls">
                                    ...
                                    <ul class="animated fast fadeOutDown" style="display: none;">
                ...
                <div class="menu_main_wrap logo_left menu_show">					
                    <div class="content_wrap clearfix">
						...
						<!-- Logo -->
						<!-- Search -->
                        <div class="search_wrap search_style_regular search_ajax inited" title="Open/close search form">
						...
						<nav class="menu_main_nav_area">
							<ul id="menu_main" class="menu_main_nav">
								...
								<li class="menu-item menu-item-has-children"><a href="<?php echo base_url();?>blog">Blog</a>
									<!-- <ul class="sub-menu">
										<li class="menu-item menu-item-has-children"><a href="#">Post Formats</a>
											<ul class="sub-menu">
												<li class="menu-item"><a href="">With Sidebar</a></li>
								...
								<li class="menu-item"><a href="<?php echo base_url();?>contact_us">Contact Us</a></li>
							</ul>
						</nav>
						<!-- /Navigation -->
                    </div>
